...
variable "public_desired_capacity" { type = number }
variable "public_min_capacity" { type = number }
variable "public_max_capacity" { type = number }
...
variable "private_desired_capacity" { type = number }
variable "private_min_capacity" { type = number }
variable "private_max_capacity" { type = number }

variable "capacity_type" { type = string }

variable "dmz_instance_types" {
    type = list(string)
    description = ""
    default = []
}

variable "sec_instance_types" {
    type = list(string)
    description = ""
    default = []
}
...
variable  "common_tags" {
  ...
  default     = {
    ...
    Environment         = "dev"
    Solution            = "1xewards"
    Terraform_workspace = "xewards-dev"
  }
...
#Network API Master permissions
